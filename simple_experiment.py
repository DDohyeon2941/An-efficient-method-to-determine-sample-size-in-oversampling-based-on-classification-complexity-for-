...
if __name__ == '__main__' :
    ...
    for fname in dataset_fnames:
            ...
            for fidx, (train_index, test_index) in enumerate(kf.split(X, y)):
                ...
                for uni_model in classifiers:
                    ...
                    for uni_ratio in Ts:
                        ...
                        result_df.loc[i] = [fname.split('.')[0], rs_idx, rs, fidx, uni_model, uni_ratio] + metrics
                        i+=1
        ...
        result_df.to_csv(r'result/prediction_performance/base/others/%s'%(fname), index=False)
